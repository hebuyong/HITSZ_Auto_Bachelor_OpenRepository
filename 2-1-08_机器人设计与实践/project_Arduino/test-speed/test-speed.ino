...
void control_lr(void)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (sensor[2])
      {
        target1 = 0.55 * V; target2 = 1 * V;
        flag = 0;     
      }
      if (sensor[6])
      {
        target1 = 1 * V; target2 = 0.55 * V;
        flag = 0; 
      }
      if (sensor[1])
      {
        target1 = 0.2 * V; target2 = 1* V;
        flag = 0;
      }
      if (sensor[7])
      {
        target1 = 1 * V; target2 = 0.2 * V;
        flag = 0;
      }
    }
  }
