...
void control_lr(void)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (sensor[3])
      {
        target1 = 0.7 * V; target2 = 0.95 * V;
        flag = 0;
      }
      if (sensor[5])
      {
        target1 = 0.95 * V; target2 = 0.7 * V;
        flag = 0;
      }
      if (sensor[2])
      {
        target1 = 0.2 * V; target2 = 0.8 * V;
        flag = 0;
      }
      if (sensor[6])
      {
        target1 = 0.8 * V; target2 = 0.2 * V;
        flag = 0;
      }
      if (sensor[1])
      {
        target1 = -0.3 * V; target2 = 1 * V;
        flag = 0;
      }
      if (sensor[7])
      {
        target1 = 1 * V; target2 = -0.3 * V;
        flag = 0;
      }
