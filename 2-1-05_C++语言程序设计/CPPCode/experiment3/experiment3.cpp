...
int main()
{
	...
	cout << "d= " << endl << d << endl;
	cout << "e(n)= " << endl << e << endl;
	//测试输入
	cout << "please input a matrix(4*4) to assign the object input_test:" << endl;
	cin >> input_test;
	cout << "input_test= " << endl << input_test << endl;
	//测试运算符重载
	d = a;
	cout << "d=a;" << endl << "d= " << endl << d << endl;
	d = m;
	cout << "d=m;" << endl << "d= " << endl << d << endl;
	d = a + c;
	cout << "d=a+c;" << endl << "d= " << endl << d << endl;
	d = a - b;
	cout << "d=a-b;" << endl << "d= " << endl << d << endl;
	d = c * e;
	cout << "d=c*e;" << endl << "d= " << endl << d << endl;
	for (int i = -3; i <= 3; i++)
	{
		d = e ^ i;
		cout << "d =e^" << i << ";" << endl << "d= " << endl << d << endl;
	}
	//测试转置、求逆等运算
	d = e.transpose();
	cout << "d=e.transpose();" << endl << "d= " << endl << d << endl;
	d = e.inverse();
	cout << "d=e.inverse();" << endl << "d= " << endl << d << endl;
	d = d * d.inverse();
	cout << "d =d*d.inverse();" << endl << "d= " << endl << d << endl;
